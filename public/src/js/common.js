        ...
        */
        ...
        if ($('.parallax-wrap').length > 0) {
            $(window).scroll(function(){
                ...
                $('.parallax-05').css({'transform' : 'translate3d(0,'+ yellowScroll +'px,0)'});
                $('.parallax-06').css({'transform' : 'translate3d(0,'+ yellowScroll +'px,0)'});
                $('.parallax-07').css({'transform' : 'translate3d(0,'+ yellowScroll +'px,0)'});
