        ...
        */
        ...
        if ($('.parallax-wrap').length > 0) {
            $(window).scroll(function(){
                ...
                $('.parallax-04').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-05').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-06').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-07').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-08').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-09').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
                $('.parallax-10').css({'transform' : 'translate3d(0,'+ scroll +'px,0)'});
            });
        }
